...
//    private int mColorText = 0x333333;
    private int mColorText = 0x33ffffff;
    ...
    private void initPickers(){
        Pickers pickers1 = new Pickers("5min", "1");
        Pickers pickers2 = new Pickers("10min", "2");
        Pickers pickers3 = new Pickers("20min", "3");
        Pickers pickers4 = new Pickers("30min", "4");
        mDataList.add(pickers1);
        mDataList.add(pickers2);
        mDataList.add(pickers3);
        mDataList.add(pickers4);
    }
